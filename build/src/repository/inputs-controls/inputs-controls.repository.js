...
class InputsControlsRepository {
    constructor() {
        ...
        this.obtenerResultadosCeprePrimerExamen = (connection, params) => __awaiter(this, void 0, void 0, function* () {
            try {
                const query = `
            SELECT 
        ...
        WHERE inscritos.PROCESO = ${params.id_proceso} AND resultados.PROCESO = ${params.id_proceso}
            ...
            `;
                ...
                manager_log_resource_1.logger.error('InputsControlsRepository.obtenerResultadosCeprePrimerExamen =>', error);
                throw error;
            }
        });
